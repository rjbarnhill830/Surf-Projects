...
const norcalSpots = [
  {
    id:"salmon-creek", name:"Salmon Creek Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:["powerful","hollow"], county:"Sonoma",
  ...
  {
    id:"doran", name:"Bodega Head / Doran Beach", bottomType:"beach", skillLevel:"beginner", waveStyle:["playful"], county:"Sonoma",
  ...
  {
    id:"dillon", name:"Dillon Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:["peaky"], county:"Sonoma",
  ...
  {
    id:"stinson", name:"Stinson Beach", bottomType:"beach", skillLevel:"beginner", waveStyle:["playful"], county:"Marin",
  ...
  {
    id:"pacifica", name:"Pacifica / Linda Mar", bottomType:"beach", skillLevel:"beginner", waveStyle:["playful","peaky"], county:"San Mateo",
  ...
  },
  {
    ...
    id:"oceanbeach", name:"The Avenues (Judah–Noriega)", group:"Ocean Beach SF", bottomType:"beach", skillLevel:"advanced", waveStyle:["powerful","hollow"], county:"San Francisco",
  ...
  {
    id:"oceanbeach-kellyscove", name:"Kelly's Cove", group:"Ocean Beach SF", bottomType:"beach", skillLevel:"intermediate", waveStyle:["playful"], county:"San Francisco",
  ...
  {
    id:"oceanbeach-vfws", name:"VFW's (Beach Chalet)", group:"Ocean Beach SF", bottomType:"beach", skillLevel:"intermediate", waveStyle:["playful","powerful"], county:"San Francisco",
  ...
  {
    id:"oceanbeach-sloat", name:"Sloat (Fleishhacker)", group:"Ocean Beach SF", bottomType:"beach", skillLevel:"advanced", waveStyle:["powerful","hollow"], county:"San Francisco",
  ...
  {
    id:"rockaway", name:"Rockaway Beach (Pacifica)", bottomType:"combo", skillLevel:"intermediate", waveStyle:["powerful","hollow"], county:"San Mateo",
  ...
  {
    id:"waddell", name:"Waddell Creek", bottomType:"combo", skillLevel:"intermediate", waveStyle:["peaky","playful"], county:"Santa Cruz",
  ...
  {
    id:"cronkite", name:"Fort Cronkite / Rodeo Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:["playful","peaky"], county:"Marin",
  ...
  {
    id:"davenport", name:"Davenport Left", bottomType:"reef", skillLevel:"advanced", waveStyle:["powerful","hollow"], county:"Santa Cruz",
  ...
  {
    id:"palomarin", name:"Palomarin / Bolinas", bottomType:"point", skillLevel:"advanced", waveStyle:["playful","peaky"], county:"Marin",
  ...
  {
    id:"rosscove", name:"Ross's Cove", bottomType:"reef", skillLevel:"advanced", waveStyle:["powerful","hollow"], county:"San Mateo",
  ...
  {
    id:"gazebos", name:"Gazebos, South Left", bottomType:"reef", skillLevel:"advanced", waveStyle:["hollow","playful"], county:"San Mateo",
    lat:37.6102, lon:-122.4963, // approximate — personal/informal name, no public spot data; placed at Rockaway (its described nearest named spot)
  ...
  {
    id:"crease", name:"Crease", bottomType:"reef", skillLevel:"advanced", waveStyle:["powerful","peaky"], county:"San Mateo",
    lat:37.6102, lon:-122.4963, // approximate — personal/informal name, no public spot data; placed at Rockaway (its described nearest named spot)
    dirMin:248, dirMax:318, facing:295, exposure:"moderate", minH:3, maxH:10, windDir:100, windTol:45, maxWind:16, tideMin:1.5, tideMax:7, minPeriod:10, maxPeriod:22, tideStation:"9414275",
  ...
  {
    id:"deadmans", name:"Deadman's", bottomType:"reef", skillLevel:"advanced", waveStyle:["powerful","peaky"], county:"San Mateo",
    lat:37.6102, lon:-122.4963, // approximate — personal/informal name, no public spot data; placed at Rockaway (its described nearest named spot)
  ...
  {
    id:"montara", name:"Montara State Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:["peaky","playful"], county:"San Mateo",
  ...
  {
    id:"sangregorio", name:"San Gregorio State Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:["playful","peaky"], county:"San Mateo",
  ...
  {
    id:"tunitas", name:"Tunitas Creek", bottomType:"beach", skillLevel:"intermediate", waveStyle:["peaky","playful"], county:"San Mateo",
  ...
  {
    id:"point-reyes-beach", name:"Point Reyes Beach", bottomType:"beach", skillLevel:"advanced", waveStyle:["powerful"], county:"Marin",
  ...
  {
    id:"kehoe-beach", name:"Kehoe Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:[], county:"Marin",
  ...
  {
    id:"drakes-beach", name:"Drakes Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:[], county:"Marin",
  ...
  {
    id:"bolinas", name:"Bolinas (Jetty / The Patch)", bottomType:"combo", skillLevel:"intermediate", waveStyle:["playful","peaky"], county:"Marin",
  ...
  {
    id:"muir-beach", name:"Muir Beach", bottomType:"point", skillLevel:"advanced", waveStyle:["powerful","playful"], county:"Marin",
  ...
  {
    id:"tennessee-valley", name:"Tennessee Valley Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:[], county:"Marin",
  ...
  {
    id:"fort-point", name:"Fort Point", bottomType:"point", skillLevel:"advanced", waveStyle:["hollow","powerful"], county:"San Francisco",
  ...
  {
    id:"mussel-rock", name:"Mussel Rock", bottomType:"reef", skillLevel:"intermediate", waveStyle:[], county:"San Mateo",
  ...
  {
    id:"sharp-park", name:"Sharp Park", bottomType:"beach", skillLevel:"advanced", waveStyle:["hollow","powerful"], county:"San Mateo",
  ...
  {
    id:"pedro-point", name:"Pedro Point", bottomType:"reef", skillLevel:"advanced", waveStyle:["powerful","hollow"], county:"San Mateo",
  ...
  {
    id:"gray-whale-cove", name:"Gray Whale Cove", bottomType:"beach", skillLevel:"beginner", waveStyle:["playful"], county:"San Mateo",
  ...
  {
    id:"mavericks", name:"Mavericks (Pillar Point)", bottomType:"reef", skillLevel:"advanced", waveStyle:["powerful","hollow"], county:"San Mateo",
  ...
  {
    id:"surfers-beach", name:"Surfer's Beach / Princeton Jetty", bottomType:"combo", skillLevel:"beginner", waveStyle:["playful"], county:"San Mateo",
  ...
  {
    id:"miramar", name:"Miramar Beach", bottomType:"beach", skillLevel:"beginner", waveStyle:["playful"], county:"San Mateo",
  ...
  {
    id:"hmb-state-beach", name:"Half Moon Bay State Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:[], county:"San Mateo",
  ...
  {
    id:"martins-beach", name:"Martins Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:[], county:"San Mateo",
  ...
  {
    id:"pomponio", name:"Pomponio State Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:["peaky","playful"], county:"San Mateo",
  ...
  {
    id:"pescadero", name:"Pescadero State Beach", bottomType:"combo", skillLevel:"intermediate", waveStyle:["peaky"], county:"San Mateo",
  ...
  {
    id:"bean-hollow", name:"Bean Hollow State Beach", bottomType:"combo", skillLevel:"intermediate", waveStyle:["peaky","playful"], county:"San Mateo",
  ...
  {
    id:"pigeon-point", name:"Pigeon Point", bottomType:"reef", skillLevel:"advanced", waveStyle:["powerful"], county:"San Mateo",
  ...
  {
    id:"ano-nuevo", name:"Año Nuevo", bottomType:"reef", skillLevel:"advanced", waveStyle:["peaky","powerful"], county:"San Mateo",
  ...
  {
    id:"scott-creek", name:"Scott Creek", bottomType:"combo", skillLevel:"intermediate", waveStyle:[], county:"Santa Cruz",
  ...
  {
    id:"panther-beach", name:"Panther Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:[], county:"Santa Cruz",
  ...
  {
    id:"bonny-doon", name:"Bonny Doon Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:[], county:"Santa Cruz",
  ...
  {
    id:"four-mile", name:"Four Mile Beach", bottomType:"reef", skillLevel:"advanced", waveStyle:["powerful","peaky"], county:"Santa Cruz",
  ...
  {
    id:"natural-bridges", name:"Natural Bridges", bottomType:"reef", skillLevel:"advanced", waveStyle:["hollow","powerful"], county:"Santa Cruz",
  ...
  {
    id:"mitchells-cove", name:"Mitchell's Cove", bottomType:"point", skillLevel:"advanced", waveStyle:["powerful"], county:"Santa Cruz",
  ...
  {
    id:"steamer-lane", name:"Steamer Lane", bottomType:"reef", skillLevel:"advanced", waveStyle:["powerful","hollow"], county:"Santa Cruz",
  ...
  {
    id:"cowells", name:"Cowell's Beach", bottomType:"beach", skillLevel:"beginner", waveStyle:["playful"], county:"Santa Cruz",
  ...
  {
    id:"pleasure-point", name:"Pleasure Point", bottomType:"reef", skillLevel:"advanced", waveStyle:["peaky","playful"], county:"Santa Cruz",
  ...
  {
    id:"capitola", name:"Capitola (Jetty / Beach)", bottomType:"reef", skillLevel:"intermediate", waveStyle:["peaky"], county:"Santa Cruz",
  ...
  {
    id:"rivermouth", name:"The Rivermouth (San Lorenzo)", bottomType:"beach", skillLevel:"intermediate", waveStyle:["peaky","playful"], county:"Santa Cruz",
  ...
  {
    id:"new-brighton", name:"New Brighton State Beach", bottomType:"beach", skillLevel:"beginner", waveStyle:["playful"], county:"Santa Cruz",
  ...
  {
    id:"seacliff", name:"Seacliff State Beach", bottomType:"beach", skillLevel:"beginner", waveStyle:[], county:"Santa Cruz",
  ...
  {
    id:"manresa", name:"Manresa State Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:["powerful","peaky"], county:"Santa Cruz",
  ...
  {
    id:"sunset-state-beach", name:"Sunset State Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:[], county:"Santa Cruz",
  ...
  {
    id:"privates", name:"Privates Beach", bottomType:"combo", skillLevel:"beginner", waveStyle:["playful"], county:"Santa Cruz",
  ...
  {
    id:"moss-landing", name:"Moss Landing", bottomType:"beach", skillLevel:"advanced", waveStyle:["powerful","hollow"], county:"Monterey",
  ...
  {
    id:"marina-state-beach", name:"Marina State Beach", bottomType:"beach", skillLevel:"intermediate", waveStyle:["peaky","playful"], county:"Monterey",
  ...
  {
    id:"monterey-state-beach", name:"Monterey State Beach", bottomType:"beach", skillLevel:"beginner", waveStyle:["playful"], county:"Monterey",
  ...
  {
    id:"del-monte", name:"Del Monte Beach", bottomType:"beach", skillLevel:"beginner", waveStyle:["playful","peaky"], county:"Monterey",
  ...
  {
    id:"lovers-point", name:"Lovers Point", bottomType:"point", skillLevel:"intermediate", waveStyle:["peaky","playful"], county:"Monterey",
  ...
  {
    id:"boneyard", name:"Boneyard (Perkins Park)", bottomType:"reef", skillLevel:"advanced", waveStyle:["powerful","hollow"], county:"Monterey",
  ...
  {
    id:"asilomar", name:"Asilomar State Beach", bottomType:"combo", skillLevel:"intermediate", waveStyle:["peaky","powerful"], county:"Monterey",
...
// The app's spot list and forecast reference points — everything else just
// reads these.
const defaultSpots = norcalSpots;
const forecastLocations = norcalForecastLocations;
